...
export async function SeoCollectionPage({ page }: { page: SeoPage }) {
  ...
  return <main className="mx-auto max-w-7xl px-4 py-8">
    ...
    <header className="rounded-3xl bg-white p-6 shadow-card"><p className="font-bold uppercase tracking-wide text-brand-orange">Shop The Snohomish</p><h1 className="mt-1 text-4xl font-black text-brand-ink sm:text-5xl">{page.heading}</h1><p className="mt-3 max-w-3xl leading-7 text-neutral-600">{page.description}</p></header>
