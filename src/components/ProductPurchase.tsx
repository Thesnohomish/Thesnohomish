...
export function ProductPurchase({ product, initialVariantId }: { product: DbProduct; initialVariantId?: string }) {
  ...
  return <div className="mt-4">
    ...
    <div className="mt-3 rounded-xl border border-yellow-300 bg-yellow-50 px-3 py-2.5 text-sm text-brand-ink"><p className="font-black">Earn {rewardPoints.toLocaleString('en-KE')} points</p></div>
