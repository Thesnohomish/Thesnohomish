...
const title = 'Your The Snohomish Customer Dashboard';
const description = 'Manage The Snohomish orders, rewards, saved addresses, favourites and customer account details.';
export const metadata: Metadata = { title, description, alternates: { canonical: '/account' }, openGraph: { title: `${title} | The Snohomish`, description, url: '/account', type: 'website' }, twitter: { card: 'summary', title: `${title} | The Snohomish`, description }, robots: { index: false, follow: false } };
