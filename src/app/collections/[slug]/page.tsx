...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }): Promise<Metadata> {
  ...
  const description = `Shop ${title.toLowerCase()} from The Snohomish with convenient drinks delivery across Nairobi.`;
