...
export async function POST(request: NextRequest) {
  ...
  const result = await deliverEmail(config.adminEmail, 'The Snohomish Email Test Successful', '<div style="font-family:Arial,sans-serif;padding:24px"><h1 style="color:#ff4b18">The Snohomish Email Test Successful</h1><p>Your Resend order-email integration is working correctly.</p></div>');
