...
export async function POST(request: NextRequest) {
  try {
    ...
    emailTasks.push(sendOrderSms(db, { id: order.id, orderNumber: order.order_number, customerPhone: body.customer.phone, customerName: body.customer.name.trim(), total, subtotal }, 'placed'));
