...
const title = 'Frequently Asked Questions – The Snohomish Nairobi';
const description = 'Answers about The Snohomish delivery, payments, product availability, customer accounts and responsible alcohol ordering in Nairobi.';
const questions = [
  ['Where does The Snohomish deliver?', 'The Snohomish serves configured delivery areas in and around Nairobi. Enter your location at checkout to see the applicable delivery fee.'],
  ...
  ['Do I need to be 18 or older?', 'Yes. The Snohomish sells alcohol only to adults aged 18 and over. Please drink responsibly.'],
];
export const metadata: Metadata = { title, description, alternates: { canonical: '/faq' }, openGraph: { title: `${title} | The Snohomish`, description, url: '/faq', type: 'website' }, twitter: { card: 'summary', title: `${title} | The Snohomish`, description } };
