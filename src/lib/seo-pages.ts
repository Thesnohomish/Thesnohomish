...
export const seoPages: Record<string, SeoPage> = {
  shop: { title: 'Shop Alcohol Online in Nairobi', heading: 'Shop The Snohomish', description: 'Shop wine, whisky, beer, gin, vodka, champagne, spirits and mixers online with fast delivery across Nairobi.', path: '/shop' },
  beer: { title: 'Beer Delivery Nairobi – Shop Beer Online', heading: 'Beer Delivery Nairobi', description: 'Shop local and imported beer online from The Snohomish with convenient delivery across Nairobi.', path: '/beer', categorySlug: 'beer' },
  ...
  whisky: { title: 'Whisky Delivery Nairobi – Shop Whisky Online', heading: 'Whisky Delivery Nairobi', description: 'Shop Scotch, bourbon and world whisky online from The Snohomish with delivery across Nairobi.', path: '/whisky', categorySlug: 'whisky' },
  ...
  vodka: { title: 'Vodka Delivery Nairobi – Shop Vodka Online', heading: 'Vodka Delivery Nairobi', description: 'Shop popular and premium vodka online from The Snohomish with fast Nairobi delivery.', path: '/vodka', categorySlug: 'vodka' },
  ...
  brandy: { title: 'Brandy Delivery Nairobi – Shop Brandy Online', heading: 'Brandy Delivery Nairobi', description: 'Shop brandy and cognac online from The Snohomish with responsible same-day delivery options across Nairobi.', path: '/brandy', categorySlug: 'brandy' },
  ...
  offers: { title: 'Alcohol Offers Nairobi – Discounted Drinks', heading: 'The Snohomish Offers', description: 'Browse currently discounted wine, beer, whisky, spirits and mixers available from The Snohomish.', path: '/offers', offers: true },
  sameDayDelivery: { title: 'Same-Day Alcohol Delivery Nairobi', heading: 'Same-Day Drinks Delivery', description: 'Order drinks online from The Snohomish for convenient same-day delivery in eligible Nairobi delivery areas.', path: '/same-day-delivery' },
  alcoholDeliveryNairobi: { title: 'Alcohol Delivery Nairobi – Order Drinks Online', heading: 'Alcohol Delivery Nairobi', description: 'Order wine, beer, whisky, gin, vodka, champagne and mixers online from The Snohomish for delivery across Nairobi.', path: '/alcohol-delivery-nairobi' },
};

export function pageMetadata(page: SeoPage): Metadata { return { title: page.title, description: page.description, alternates: { canonical: page.path }, openGraph: { title: `${page.title} | The Snohomish`, description: page.description, url: page.path, type: 'website' }, twitter: { card: 'summary', title: `${page.title} | The Snohomish`, description: page.description } }; }
